const translations = {
  en: {
    ...
    reviewSubtitle: "Tell us about your experience with DutsiCakes 🍰",
    ...
    productDescriptions : {
      "campfire-chip": {
        ...
        es: "Relleno cremoso de malvavisco y chocolate dentro de una clásica galleta con chispas de chocolate."
      },
      "berry-bright": {
        ...
        es: "Galleta esponjosa de limón cubierta con cremoso glaseado de limón y espolvoreada con fresas liofilizadas agridulces para un final brillante y refrescante."
      },
      "cookie-butter-dream": {
      ...
      "velvet-classic": {
        ...
        es: "Cupcake de red velvet coronado con glaseado de queso crema de toque ácido."
      },
      "cookie-crush": {
      ...
      "choco-bomb": {
        ...
        es: "Cupcake de chocolate húmedo con glaseado de queso crema y chocolate estilo fudgy."
      },
      "citrus-zen": {
        en: "Earthy matcha cupcake topped zesty lemon cream cheese frosting",
        es: "Cupcake de matcha de notas terrosas coronado con glaseado de queso crema al limón."
      },
      "berry-cloud": {
      ...
      "custom-cupcakes-jumbo": {
        ...
        es: "Tus cupcakes jumbo soñados, hechos realidad. Trabajamos con tus ideas, sabores favoritos y paletas de color para crear los cupcakes personalizados perfectos para cualquier ocasión."
      },
      "custom-cupcakes-regular": {
        ...
        es: "Tus cupcakes regulares soñados, hechos realidad. Trabajamos con tus ideas, sabores favoritos y paletas de color para crear los cupcakes personalizados perfectos para cualquier ocasión."
      },
      "cinnamon-spell": {
        en: "Pumpkin spice cake topped with brown sugar cinnamon frosting",
        es: "Pastel especiado de calabaza coronado con glaseado de canela y azúcar moreno."
      },
      "halloween-sugar": {
        ...
        es: "Galleta de azúcar masticable en un mosaico de colores espeluznantes de Halloween —naranja, verde, morado y negro— rematada con divertidos dulces y ojitos de azúcar."
      },
      "toffee-temptation": {
        en : "Double chocolate chip cookie topped with rich toffee",
  ...
  es: {
    ...
    aboutUsText: "Pequeña descripción de la marca para SEO.",
    ...
    nameLabel: "Nombre",
    reviewTitle: "Deja tu Reseña",
    reviewSubtitle: "Cuéntanos tu experiencia con DutsiCakes 🍰",
    reviewFormTitle: "Formulario de Reseña",
    reviewName: "Nombre",
    ...
    about: {
      ...
      lead: "Dutsi Cakes es una micro-panadería familiar que convierte cupcakes y cookies en pequeñas obras de arte comestibles.",
      body: {
        p1: "Creemos que cada sabor cuenta una historia: desde un clásico rico y fudgy hasta una creación cítrica y brillante. Renovamos y rotamos el menú cada pocos meses para traerte favoritos de temporada y especialidades exclusivas.",
        p2: "Nuestro menú personalizado —disponible para celebraciones, bodas y eventos— te permite dar vida a tu visión con sabores y diseños hechos a tu medida. Cuidamos cada detalle para que cada postre sea verdaderamente inolvidable.",
      },
      photoCaption: "Head Baker",
